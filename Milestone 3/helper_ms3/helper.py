...
def parse_game_events(game_data: dict) -> pd.DataFrame:
    ...
    # List to store the game infos
    #game_infos = []
    #game_infos.append({
    #    'home_team': game_data.get('homeTeam', {}).get('id'),
    #    'home_team_abbrev': game_data.get('homeTeam', {}).get('abbrev'),
    #    'away_team': game_data.get('awayTeam', {}).get('id'),
    ...
    for event in events:
        ...
        if event_type in ['shot-on-goal', 'goal']:
            event_data.append({
                ...
                #'home_team': True if event.get('details', {}).get('eventOwnerTeamId') == game_infos['home_team'] else None,
                #'home_team_abbrev': game_infos['home_team_abbrev'] if event.get('details', {}).get('eventOwnerTeamId') == game_infos['home_team'] else None,
                #'away_team': True if event.get('details', {}).get('eventOwnerTeamId') == game_infos['away_team'] else None,
                #'away_team_abbrev': game_infos['away_team_abbrev'] if event.get('details', {}).get('eventOwnerTeamId') == game_infos['away_team'] else None,
